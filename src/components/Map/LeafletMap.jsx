...
import { totalBounds, allCountryBounds } from "../../data/bounds";
  ...
  return (
    <>
      <MapContainer
        ...
        //make it solid boundary and disallow users to pan out too much
      ...
      >
        ...
        <TileLayer
          ...
          //stamen tiles API call doesn't work anymore
          // As of July 31, 2023, Stamen Map Tiles are served by Stadia Maps.https://maps.stamen.com/#watercolor/12/37.7706/-122.3782
          //stadiamaps hosting stamen tiles
          subdomains="abcd"
          minZoom={0}
          maxZoom={18}
          ext="png"
